        ...
        static void AddClientEntries()
        {
            using (var db = new TCCFEntities())
			{
                ...
                { // 
                    ...
                    NomeLivro = "The Legend Of Zelda: Majora's Mask - A Link To The Past; Perfect Edition",
                ...
                var (senha, salt) = Authentication.RegisterUser("12345");
                ...
                (senha, salt) = Authentication.RegisterUser("12345");
                db.tblLeitor.Add(new tblLeitor()
                {
                    tblTipoLeitor = TipoLeitorNormal,
